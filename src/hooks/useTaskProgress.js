...
function getTaskXpReward(taskKey) {
  const dkd_key_value = String(taskKey || '');
  if (dkd_key_value === 'chest_1' || dkd_key_value === 'chest_3') return XP_REWARDS.task_daily_small;
  if (dkd_key_value === 'boss_1') return XP_REWARDS.task_daily_boss;
  if (dkd_key_value === 'bonus') return XP_REWARDS.task_daily_bonus;
  if (dkd_key_value === 'w_chest_10') return XP_REWARDS.task_weekly_small;
  if (dkd_key_value === 'w_boss_3') return XP_REWARDS.task_weekly_boss;
  if (dkd_key_value === 'w_unique_5' || dkd_key_value === 'w_bonus') return XP_REWARDS.task_weekly_bonus;
  return 0;
}
