...
export function useChestActions({
  ...
  }, [bossState, visibleDrops, beginAction, endAction, setBossOpen, setActiveDropId, resetChest, loc?.lat, loc?.lng, refreshProfile, refreshUserDrops, bumpChestsOpened, grantXp, onAchievementAction, syncProfileFromOpen, revealPayload, runFollowupRefreshes, runRefresh, syncTicketsFromOpen, attachCampaignCoupon, applyLocalCampaignStockDelta]);
