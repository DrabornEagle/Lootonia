...
function prettyShopReason(reason) {
  ...
  if (key === 'invalid_kind' || key === 'invalid_reward_kind') return 'Paket anahtarı veya ödül türü eşleşmedi. Market Komuta içinden pack key ve ödül türünü kontrol et.';
