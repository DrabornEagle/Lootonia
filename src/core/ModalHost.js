...
import dkd_applications_hub_modal_value from '../features/applications/dkd_applications_hub_modal';
...
const dkd_applications_modal_registry_value = { dkd_applications_hub_modal_value };
  ...
  return (
    <>
      ...
      {activeTab === 'applications' ? (
        <dkd_applications_modal_registry_value.dkd_applications_hub_modal_value
          dkd_visible_value
