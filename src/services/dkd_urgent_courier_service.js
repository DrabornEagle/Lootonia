...
export async function dkd_create_urgent_courier_order(dkd_input_value = {}) {
  ...
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_order_created', dkd_rpc_result_order_id_value(dkd_normalized_result_value));
  }
...
export async function dkd_cancel_urgent_courier_order(dkd_order_id_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_order_cancelled', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_offer_urgent_courier_fee(dkd_order_id_value, dkd_courier_fee_tl_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_courier_accepted', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_approve_urgent_courier_fee(dkd_order_id_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_auto_message', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_reject_urgent_courier_fee(dkd_order_id_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_fee_rejected', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_set_urgent_courier_product_total(dkd_order_id_value, dkd_product_total_tl_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_product_total_sent', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_upload_urgent_courier_invoice(dkd_order_id_value, dkd_invoice_image_url_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_invoice_uploaded', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_pickup_urgent_courier_items(dkd_order_id_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_items_picked_up', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_complete_urgent_courier_delivery(dkd_order_id_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event('dkd_urgent_delivery_completed', dkd_rpc_result_order_id_value(dkd_normalized_result_value, dkd_order_id_value));
  }
  return dkd_normalized_result_value;
}
...
export async function dkd_send_urgent_courier_message(dkd_order_id_value, dkd_message_text_value) {
  ...
  const dkd_normalized_result_value = dkd_normalize_rpc_response_value(dkd_result_value);
  if (!dkd_normalized_result_value?.error) {
    dkd_emit_urgent_courier_push_event(
