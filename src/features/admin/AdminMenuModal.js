...
export default function AdminMenuModal({ visible, onClose, onLoot, onDrops, onUsers, onCourierJobs, onBroadcast, onBoss, onMarket }) {
          ...
          <LinearGradient colors={['#04101A', '#0B1426', '#090E18']} style={dkd_styles.card}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={dkd_styles.scrollContent}>
              <View style={dkd_styles.grid}>
                ...
                <AdminAction icon="truck-fast-outline" title="Kurye Masası" sub="Görev havuzu, pickup ve teslimat akışını yönet" onPress={onCourierJobs} tone="green" />
