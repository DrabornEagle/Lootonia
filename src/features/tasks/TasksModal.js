...
function TasksModal({
  ...
  const daily = ts || { day: today, chests_opened: 0, boss_solved: false, claims: {} };
  const weekly = ws || { week, chests_opened: 0, boss_opened: 0, unique_drops: 0, claims: {} };
  const dailyClaims = daily?.claims || {};
  const weeklyClaims = weekly?.claims || {};
