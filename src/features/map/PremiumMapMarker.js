...
const MARKER_ASSETS = {
  ...
  dkd_chest: require('../../../assets/mapmarkers/chest.png'),
...
export function resolveMarkerKey(drop = {}) {
  ...
  if (type.includes('boss') || name.includes('boss')) return 'boss';
  if (type.includes('chest') || type.includes('sandik') || type.includes('sandık') || name.includes('chest') || name.includes('sandik') || name.includes('sandık')) return 'dkd_chest';
