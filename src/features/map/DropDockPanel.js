        ...
        {!collapsed ? (
          <>
            ...
            <View style={styles.actionRow}>
              ...
              <View style={{ width: 10 }} />
              <ActionButton label={dockPreview ? 'Hedefe Git' : 'Hedef Seç'} icon="radar" onPress={() => dockPreview ? onDirections?.(dockPreview) : onOpenList?.()} primary compact />
            </View>
          </>
        ) : (
          <View style={styles.collapsedActionRow}>
            <ActionButton label="Liste" icon="format-list-bulleted-square" onPress={onOpenList} compact />
            <View style={{ width: 8 }} />
            <ActionButton label={dockPreview ? 'Git' : 'Seç'} icon="radar" onPress={() => dockPreview ? onDirections?.(dockPreview) : onOpenList?.()} primary compact />
          </View>
        )}
      </LinearGradient>
