...
function dkd_render_courier_order_category_panel_value(dkd_mode_value, dkd_on_open_courier_board_value) {
  ...
  const dkd_palette_value = dkd_is_urgent_value
    ? {
      ...
      dkd_subtitle_value: "Eczane, fırın, market, belge veya küçük paket gibi acil teslimatları kurye akışına bağlayan ayrı sipariş kategorisi.",
...
export default function MarketModal({
  ...
  const [dkd_market_section, dkd_set_market_section] = useState("merchant");
  ...
  const dkd_market_section_cards = useMemo(
    () => [
      {
        key: "merchant",
        title: "Yemek/Market Siparişleri",
        subtitle: "Yiyecek ve Market Siparişlerinizi sipariş verin.",
        ...
        badge: `${formatNum(dkd_food_product_count_value + dkd_market_product_count_value)} ürün`,
      },
      {
        key: "urgent",
        title: "Acil Kurye Siparişleri",
        subtitle: "Hızlı al-götür ve canlı teklif akışı",
        icon: "bike-fast",
        iconBg: "rgba(255,184,107,0.18)",
        iconBorder: "rgba(255,184,107,0.30)",
        colors: ["rgba(126,42,38,0.98)", "rgba(40,16,34,0.98)"],
        badge: "Hızlı kurye",
      },
      {
        key: "sell",
        title: "Kart Satış İlanları",
        subtitle: "Koleksiyon kartlarını ayrı pazarda sat",
      ...
      },
      {
        ...
        subtitle: "Enerji, shard ve görev takviyesi",
    ...
    [dkd_food_product_count_value, dkd_market_product_count_value, marketShopDefs.length, ownListings.length],
  );
    ...
    <View style={styles.headerWrap}>
      <View style={styles.topBar}>
        <View style={styles.topCopy}>
          <Text style={styles.topKicker}>LOOTONIA SİPARİŞ MARKETİ</Text>
          <Text style={styles.topTitle}>Alışveriş, kurye ve kart pazarı</Text>
        </View>
      ...
      <View style={styles.statsRow}>
        ...
        <StatBox
          ...
          label="Sipariş ürünü"
          value={formatNum(merchantProducts.length)}
        ...
        {dkd_market_section_cards.map((dkd_section_card) => {
          ...
          return (
            <Pressable
              ...
              onPress={() => dkd_handle_market_section_card_press_value(dkd_section_card.key)}
              style={({ pressed }) => [
      ...
      {dkd_market_section === "shop" ? (
        <View style={styles.panelCard}>
          <LinearGradient
            ...
            style={StyleSheet.absoluteFill}
          />
          <Text style={styles.panelEyebrow}>TAKVİYE ÜRÜNLERİ</Text>
          <Text style={styles.panelTitle}>Hızlı oyun takviyesi vitrini</Text>
          <Text style={styles.panelSub}>
            Enerji, shard ve görev desteğini ayrı kategori içinde tutan kompakt takviye mağazası.
          </Text>
